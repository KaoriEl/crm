...
/* harmony import */ var _toast_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toast.js */ "./resources/js/toast.js");
...
window.toast = _toast_js__WEBPACK_IMPORTED_MODULE_0__["default"];
/**
...
$(function () {
  ...
  var username_auth = 'redaktor';
  var password_auth = '0fAIGwVlTN'; //var Inputmask = require('inputmask');
  ...
  var checkboxGroups = ['posting', 'targeting', 'seeding', 'commercial_seed'];
  ...
  function postCreated(payload) {
    Object(_toast_js__WEBPACK_IMPORTED_MODULE_0__["default"])(payload.title, 'Новая задача');
  }

  function ideaCreated(payload) {
    Object(_toast_js__WEBPACK_IMPORTED_MODULE_0__["default"])(payload.text, 'Новая идея');
  }

  if (window.App && App.User) {
    Echo["private"]('journalists').listen('PostCreated', postCreated);
    Echo["private"]('App.User.' + App.User.id).listen('PostCreated', postCreated).listen('IdeaCreated', ideaCreated);
  ...
  $(document).ready(function () {
    var post_id = $('.text-muted');
    $.each(post_id, function (id) {
      var takePost = this.id;
      $.ajax({
        method: "POST",
    ...
    $('.statistic').on('click', function () {
      ...
      var post_id = this.id;
      var takePost = post_id; // console.log(this.id);
    ...
    function GenerateSumStatistic(statistic, SocialNetworks, SocialNetworksSlug) {
      ...
      $("#StatisticTable").append(" <tr data-toggle=\"collapse\" data-target='#" + SocialNetworksSlug + " ' data-parent=\"#StatisticTableHeader\">" + "<th scope=\"row\" style=' max-width: 10px; cursor: pointer; border: 1px solid #dee2e6 !important;' > <span class=\"mdi mdi-arrow-down-drop-circle mdi-14px mr-2\"></span>" + SocialNetworks + "</th> <td style='cursor: pointer; border: 1px solid #dee2e6 !important;'> <span>" + sumViews + "</span></td>" + "<td style='cursor: pointer; border: 1px solid #dee2e6 !important;'> <span>" + Math.floor(sumViewsFeature) + "</span></td>" + "<td style='cursor: pointer; border: 1px solid #dee2e6 !important;'><span>" + sumLike + "</span></td>" + "<td style='cursor: pointer; border: 1px solid #dee2e6 !important;'><span>" + sumComments + "</span></td>" + "<td style='cursor: pointer; border: 1px solid #dee2e6 !important;'><span>" + sumReposts + "</span></td>" + "<td style='cursor: pointer; border: 1px solid #dee2e6 !important;'><span>" + sumFollowers + "</span></td>" + "<td style='cursor: pointer; border: 1px solid #dee2e6 !important;'><span>" + sumER.toFixed(2) + "</span></td>" + "</tr>");
    ...
    function addtable(like, repost, views, comments, commercial, acc_name, followers, link, text, sum, SocialNetworksSlug) {
      ...
      if (commercial === "Y") {
        $("#StatisticTable").append("<tr id='" + SocialNetworksSlug + "' class=\"collapse smoth_fade\" style='background: #dffff9;'>" + "<td  class=\"hiddenRow smoth_fade\" style='width: 50%; border: 1px solid #dee2e6 !important;' ><a href='" + link + "' target='_blank'>" + text + " <span>[Коммерческий выход]</span></a></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + views + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + Math.floor(ViewsFeature) + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + like + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + comments + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + repost + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + acc_name + " <span class='mdi mdi-arrow-right-bold-outline mdi-14px mr-2' style='display: contents;'></span> " + followers + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + ER.toFixed(2) + "</span></td>" + "</tr>");
      } else {
        $("#StatisticTable").append("<tr id='" + SocialNetworksSlug + "' class=\"collapse smoth_fade\">" + "<td  class=\"hiddenRow smoth_fade\" style='width: 50%; border: 1px solid #dee2e6 !important;' ><a href='" + link + "' target='_blank'>" + text + "</a></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + views + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + Math.floor(ViewsFeature) + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + like + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + comments + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + repost + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + acc_name + " <span class='mdi mdi-arrow-right-bold-outline mdi-14px mr-2' style='display: contents;'></span> " + followers + "</span></td>" + "<td  class=\"hiddenRow smoth_fade\" style='border: 1px solid #dee2e6 !important;'><span>" + ER.toFixed(2) + "</span></td>" + "</tr>");
      }
    ...
    function GenerateDashboardIcons(data, takePost) {
      ...
      $("#StatisticPreview" + takePost).append("<span class=\"mdi mdi-eye-outline mdi-18px mr-2\">" + " " + sumViews + "</span>" + "<span class=\"mdi mdi-thumb-up-outline mdi-18px mr-2\">" + " " + sumLike + "</span>" + "<span class=\"mdi mdi-comment-multiple-outline mdi-18px mr-2\">" + " " + sumComments + "</span>" + "<br>" + "<span class=\"mdi mdi-share-all-outline mdi-18px mr-2\">" + " " + sumReposts + "</span>" + "<span class=\"mdi mdi-account-plus-outline mdi-18px mr-2\">" + " " + sumFollowers + "</span>" + "<span class=\"mdi mdi-percent mdi-18px mr-2\">" + " " + sumER.toFixed(2) + "</span>");
    }
  });
  $(document).ready(function () {
    ...
    if (window.location.pathname === "/profile/ok") {
      if (window.location != "") {
        var _token = window.location;
        _token = _token.search;
        _token = _token.substr(1);
        console.log(_token);
        console.log('token');
        $.ajax({
          method: "POST",
          url: "/authUserOK/" + _token,
          data: {
            token: _token
          },
          headers: {
  ...
  $('#auth_user').on('click', function () {
    var username = $('[name ^= "username_insta"]').val();
    var password = $('[name ^= "password_insta"]').val();
    var url = '';
  ...
  $('#btn_post_sms_to_auth').on('click', function () {
    ...
    var api_path = $('[name ^= "api_path"]').val();
    var url = '';
  ...
  $('.dataTables_length').addClass('bs-select'); // requires jquery library
...
$('.inst').click(function () {
  var clickId = $(this).attr('id');
  var instcount = $('#' + clickId);
  var inst = $('#link' + clickId);
...
$('.vkcomm').click(function () {
  var clickId = $(this).attr('id');
  var vkcommcount = $('#' + clickId);
  var vkcomm = $('#link' + clickId);
...
window.Dropzone = __webpack_require__(/*! dropzone */ "./node_modules/dropzone/dist/dropzone.js"); // jQuery plugins
...
__webpack_require__(/*! datatables.net-bs4 */ "./node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js"); // Bootstrap
...
function toast(message, title) {
  ...
  var $toasts = $('#toasts');
  var $message = $('<div role="alert" aria-live="assertive" aria-atomic="true" class="toast" data-autohide="false">' + '<div class="toast-header">' + // '<img src="..." class="rounded mr-2" alt="...">' +
  '<strong class="mr-auto">' + title + '</strong>' + '<small>' + time + '</small>' + '<button type="button" class="ml-2 mb-1 close" data-dismiss="toast" aria-label="Close">' + '<span aria-hidden="true">&times;</span>' + '</button>' + '</div>' + '<div class="toast-body">' + message + '</div>' + '</div>');
...
__webpack_require__(/*! F:\openserver\OpenServer\domains\ytg-die\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\openserver\OpenServer\domains\ytg-die\resources\sass\app.scss */"./resources/sass/app.scss");
