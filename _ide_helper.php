 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \Barchart\Laravel\RememberAll\SessionGuard $instance */
         ...
         *
         * @param \Illuminate\Contracts\Auth\Authenticatable $user
         * @return \Barchart\Laravel\RememberAll\SessionGuard 
         * @static 
         */ 
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        \Barchart\Laravel\RememberAll\SessionGuard::macro($name, $macro);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        \Barchart\Laravel\RememberAll\SessionGuard::mixin($mixin, $replace);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        return \Barchart\Laravel\RememberAll\SessionGuard::hasMacro($name);
        }
