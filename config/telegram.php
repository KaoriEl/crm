...
return [
    ...
    */
    'bots' => [
        'common' => [
            'username'  => 'editorial_office_bot',
            'token' => env('TELEGRAM_BOT_TOKEN', '808041408:AAGmdjdNonMvPl0e2eAJP1ksi3zdFs8SPkU'),
            'commands' => [
                App\CommandBot\StartCommand::class,
                App\CommandBot\PostCommand::class
