...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'draft_url'             => 'Ссылка на черновик',
        'publication_url'       => 'Ссылка на публикацию',
        'vk_post_url'           => 'Ссылка на пост в ВК',
        'tt_post_url'           => 'Ссылка на пост в ТТ',
        'ok_post_url'           => 'Ссылка на пост в ОК',
        'fb_post_url'           => 'Ссылка на пост в ФБ',
        'ig_post_url'           => 'Ссылка на пост в Инстаграме',
        'seed_list_url'         => 'Ссылка на список групп',
        'timezone'              => 'Часовой пояc',
    ],
];
