                        ...
                        <tr class="{{ $post->done() ? ' table-success': '' }}">
                                                ...
                                                <div class="modal-body">
                                                    <table class="table table-hover" id="StatisticTableHeader">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th title="Просмотры" scope="col" class="mdi mdi-eye mdi-18px mr-2" style="text-align: center;"></th>
                                                            <th title="Прогнозные просмотры" scope="col" class="mdi mdi-chart-areaspline mdi-18px mr-2" style="text-align: center;"></th>
                                                            <th title="Лайки" scope="col" class="mdi mdi-thumb-up mdi-18px mr-2" style="text-align: center;" ></th>
                                                            <th title="Комментарии" scope="col" class="mdi mdi-comment-multiple mdi-18px mr-2" style="text-align: center;"></th>
                                                            <th title="Репосты" scope="col" class="mdi mdi-share-all mdi-18px mr-2" style="text-align: center;"></th>
                                                            <th title="Кол-во подписчиков" scope="col" class="mdi mdi-account-plus mdi-18px mr-2" style="text-align: center;" ></th>
                                                            <th title="ER (вовлеченность)" scope="col" class="mdi mdi-percent mdi-18px mr-2" style="text-align: center;" ></th>
                            ...
                            <td class="text-nowrap">
                                ...
                                @elseif ($post->draft_url && $post->approved === null)
                                    <span class="badge badge-orange">нужна проверка</span>
                                @elseif ($post->draft_url && !$post->approved)
                                    <small class="badge badge-aque">на доработке</small>
                                @elseif ($post->hasJournalist())
                                    <small class="badge badge-primary">в работе</small>
                                @else
                                    <span class="badge badge-danger">не в работе</span>
                            ...
                            <td class="">
                                ...
                                {!! $post->seed_list_url ? "<a href=".$post->seed_list_url." target='blank'>":'' !!}
                                <small
                                    class="label{{ $post->seeding && $post->seeding_to_fb ? '' : ' label-invisible' }}{{ $post->seed_list_url ? ' label-done' : '' }}">FB</small>{!! $post->seed_list_url ? "</a>":'' !!}{!! $post->seeding_to_fb ? "<br>":'' !!}
                                {!! $post->seed_list_url ? "<a href=".$post->seed_list_url." target='blank'>":'' !!}
                                <small
                                    class="label{{ $post->seeding && $post->seeding_to_insta ? '' : ' label-invisible' }}{{ $post->seed_list_url ? ' label-done' : '' }}">Insta</small>{!! $post->seed_list_url ? "</a>":'' !!}{!! $post->seeding_to_insta ? "<br>":'' !!}
                                {!! $post->seed_list_url ? "<a href=".$post->seed_list_url." target='blank'>":'' !!}
                                <small
                            ...
                            @hasanyrole('admin|editor|targeter')
                            <td class="">
                            ...
                            @hasanyrole('editor')
                            <td class="">
                                <a href="{{ route('posts.copy',$post->id) }}" class="btn btn-success">Копировать</a>
                            </td>
                            @endhasanyrole
                        </tr>
                    @endif
