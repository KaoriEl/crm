                        ...
                        <div class="col">
                            <div class="form-group">
                                <input type="text" id="post-expire-date-selector" name="expires_at"
                                       ...
                                       value="{{ old('expires_at', $post->expires_at->setTimezone(Auth::user()->timezone)->format('d.m.Y H:i')) }}"
                                       required>
...
{{--                                </div>--}}
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="hidden" name="posting_to_tt" value="0">
                                    <input type="checkbox" class="custom-control-input" name="posting_to_tt"
                                           id="posting_to_tt" value="1" {{ $post->posting_to_tt ? ' checked' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="hidden" name="commercial_seed" value="0">
...
{{--                        <div class="col-2">--}}
{{--                            <div class="form-group">--}}
{{--                                <label for="posting">Коммерческие посевы</label>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                               name="commercial_seed_to[{{ $socialNetwork->id }}]"--}}
{{--                                               id="commercial_seed_to_{{ $socialNetwork->id }}" value="{{ $socialNetwork->id }}"--}}
{{--                                               data-social-id="{{ $socialNetwork->id }}" {{ in_array($socialNetwork->id, $selectedSocialSeedNetworks) ? ' checked' : '' }}>--}}
{{--                                        <label for="commercial_seed_to_{{ $socialNetwork->id }}"--}}
                                ...
                                @foreach($socialNetworks as $socialNetwork)
                                    <div class="custom-control custom-checkbox"
                                        ...
                                        <input type="number" class="form-control target-input"
                                               ...
                                               data-social-id="{{ $socialNetwork->id }}"
                                               style="width: 100px;" value="{{ $post->socialNetworks()->withPivot('price')->wherePivot('social_network_id', $socialNetwork->id)->first()->pivot->price ?? null }}">
                                    </div>
                                @endforeach
                            </div>
                            {{--                        <div class="form-group">--}}
