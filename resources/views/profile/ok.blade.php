        ...
        <div class="row">
            <div class="col-3">
                <ul class="nav nav-tabs flex-column" role="tablist">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('profile.ok') }}" class="nav-link {{request()->routeIs('profile.ok') ? ' active' : '' }}" id="home-tab">OK аккаунт</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col" style="display: grid;">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h5>Авторизация OK аккаунта</h5>
                        <label for="tokenget">Откройте ссылку в режиме инкогнито:</label>
                        <a id="tokenget"  target="_blank" href="https://connect.ok.ru/oauth/authorize?client_id=512001057121&scope=VALUABLE_ACCESS;LONG_ACCESS_TOKEN&&response_type=code&redirect_uri={{config('app.OK_APP_URL')}}&layout=*w">Получить токен</a>
                        <br>
                    </div>
                </div>
